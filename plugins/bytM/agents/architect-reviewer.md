...
description: bytM specialist agent (on-demand). Validates architectural decisions, reviews system design, and assesses scalability. Not a core team workflow member.
...
4. Delegate implementation to appropriate agents
...
- GOOD: "Add database index on user_id to optimize time entry queries, currently O(n) on tables >10k rows"
...
- **Nur kritische Findings** detailliert erklaeren
