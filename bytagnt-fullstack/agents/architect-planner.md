...
description: Architecture planning specialist. Creates Technical Specifications BEFORE implementation. Guides all downstream agents with architecture knowledge.
...
═══════════════════════════════════════════════════════════════
Proceed to Phase 1 (UI/UX Design)?
═══════════════════════════════════════════════════════════════
```
